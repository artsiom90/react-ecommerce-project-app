...
export enum AppActionEnum {
    ...
    SET_CARD_ITEM_QUANTITY = 'SET_CARD_ITEM_QUANTITY',
...
export interface SetCardItemQuantityActionType {
    type: AppActionEnum.SET_CARD_ITEM_QUANTITY
    payload: number
}
